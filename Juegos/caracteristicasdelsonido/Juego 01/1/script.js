...
function createPuzzle() {
  ...
  // ======================================================
  // AHORA EL PUZZLE ES UN GRID REAL
  // ======================================================
  puzzleElement.style.setProperty("--cols", gridSize);
  puzzleElement.style.setProperty("--rows", gridSize);
  puzzleElement.classList.add("grid-ready");

  // Generación de celdas SIN filas <div class="row">
  for (let i = 0; i < gridSize; i++) {
    ...
    for (let j = 0; j < gridSize; j++) {
      ...
      // Se agrega directamente al GRID
