...
const instruments = [
{ name: "arpa", type: "Cuerdas" },
{ name: "acordeón", type: "Vientos" },
{ name: "bandoneón", type: "Vientos" },
{ name: "bombo", type: "Percusión" },
{ name: "caja chayera", type: "Percusión" },
{ name: "charango", type: "Cuerdas" },
{ name: "erke", type: "Vientos" },
{ name: "erkencho", type: "Vientos" },
{ name: "guitarra", type: "Cuerdas" },
{ name: "ocarina", type: "Vientos" },
{ name: "palo de lluvia", type: "Percusión" },
{ name: "sikus", type: "Vientos" },
{ name: "quena", type: "Vientos" },
{ name: "pesuñas", type: "Percusión" },
{ name: "tarka", type: "Vientos" },
{ name: "violín", type: "Cuerdas" }
];
...
function saveGameScore() {
    ...
    saveGameResultToFirebase(score, "INSTR_clsf1", "Clasificación de Instrumentos Musicales", usuario);
}
...
document.getElementById("cuerdas-button").addEventListener("click", () => checkAnswer("Cuerdas"));
document.getElementById("percusin-button").addEventListener("click", () => checkAnswer("Percusión"));
