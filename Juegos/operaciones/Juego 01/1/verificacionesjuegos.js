...
// ⭐⭐⭐ Verificación previa: si es DOCENTE, omitir todas las verificaciones ⭐⭐⭐
const esUsuarioDocente = await esDocente(uid);

if (esUsuarioDocente) {
    console.log("Acceso docente permitido sin restricciones.");
...
async function esDocente(uid) {
    try {
        ...
        console.error("Error verificando rol docente:", error);
        return false;
    }
}
