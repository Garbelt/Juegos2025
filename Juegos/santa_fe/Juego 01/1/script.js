...
document.addEventListener("DOMContentLoaded", () => {
  ...
  /* -------------------------------
     ...
     gameCode: DTOS_sei
     title: "Señalar los departamentos de Santa Fe en el mapa"
  -------------------------------- */
  const GAME_CODE = "DTOS_sei";
  const GAME_TITLE = "Señalar los departamentos de Santa Fe en el mapa";
...
if (zonaIndicacion){
  zonaIndicacion.classList.add("indicacion-oculta");
}
