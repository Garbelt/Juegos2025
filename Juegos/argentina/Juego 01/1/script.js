...
// script.js - Juego de señalar en la imagen con guardado LOCAL + FIREBASE (DTOS_sei)
  ...
  /* -------------------------------
     ...
     gameCode: PCIAS_sei
     title: "Señalar las provincias argentinas en el mapa"
  -------------------------------- */
  const GAME_CODE = "PCIAS_sei";
  const GAME_TITLE = "Señalar las provincias argentinas en el mapa";
...
function ajustarMapa() {
  ...
  const altoOriginal = img.naturalHeight || 1451;
