...
const instruments = [
{ name: "MADRE", type: "FEMENINO" },
{ name: "PERRO", type: "MASCULINO" },
{ name: "LUNA", type: "FEMENINO" },
{ name: "SERPIENTE", type: "FEMENINO" },
{ name: "BURRO", type: "MASCULINO" },
{ name: "LEÓN", type: "MASCULINO" }
];
...
function saveGameScore() {
    ...
    saveGameResultToFirebase(score, "PLBRS_genero", "Reconocer género masculino y femenino", usuario);
}
...
document.getElementById("masculino-button").addEventListener("click", () => checkAnswer("MASCULINO"));
document.getElementById("femenino-button").addEventListener("click", () => checkAnswer("FEMENINO"));
