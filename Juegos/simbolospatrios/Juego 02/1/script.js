...
document.addEventListener("DOMContentLoaded", () => {
    ...
    const timeLimit = 60; // Límite de tiempo en segundos
...
function showSolvedMessage() {
    ...
    score = baseScore + remainingScore;  // actualizar puntaje
...
function showTimeUpMessage() {
    score = Math.max(0, score - (timeLimit - time));
...
function endGame() {
    ...
    firebase.database().ref("games").push().set({
        ...
        game: "SMBLS_rmpc02",
        puntaje: score,
        title: "Rompecabezas del Escudo Nacional Argentino",
        usuario: usuario
    })
